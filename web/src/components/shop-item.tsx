...
export default function ShopItem({
    ...
    return (
        <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-50 to-white shadow-xl transition-all duration-500 hover:shadow-2xl hover:-translate-y-1">
            ...
            <div className="p-8">
                ...
                <div className="mb-6 grid grid-cols-2 gap-3">
                    ...
                    <div className="rounded-xl bg-gradient-to-br from-orange-50 to-orange-100/50 p-4 transition-colors hover:from-orange-100 hover:to-orange-200/50">
                        <div className="mb-1 flex items-center gap-2">
                            <Icon icon="mdi:arrow-expand-vertical" className="h-5 w-5 text-orange-600" />
                            <span className="text-xs font-medium text-orange-900">Hover Height</span>
                        </div>
                ...
                <Link
                    href="/shop/mk1pro"
                    className="group/btn relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-slate-900 px-8 py-4 text-base font-semibold text-white shadow-lg transition-all duration-300 hover:bg-slate-800 hover:shadow-xl hover:scale-[1.02] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-900"
                >
                    <span className="relative z-10">Learn more</span>
                    <Icon icon="mdi:arrow-right" className="relative z-10 h-5 w-5 transition-transform group-hover/btn:translate-x-1" />
